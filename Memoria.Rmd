...
No obstante, aunque se preservó la imagen original completa, fue necesario realizar un paso de estandarización de escala. Dado que las imágenes provenían de diversas fuentes con resoluciones muy dispares, procesarlas en su tamaño original podría aumentar el coste computacional, especialmente al calcular características complejas como texturas o conversiones de espacios de color. Por ello, se aplicó un redimensionado proporcional a todas las imágenes, reduciendo su tamaño a una resolución manejable que permitiera agilizar el entrenamiento sin degradar la información visual necesaria para distinguir el momento del día. 

Se utilizó fijar el lado mayor de la imagen a un máximo de 224 píxeles, estableciendo una 'caja delimitadora' (bounding box) de 224x224. Esta medida no fue arbitraria, sino seleccionada para coincidir con la resolución nativa de una parte de nuestro dataset original: las 124 imágenes del dataset de Kaggle ya tenían este tamaño. Al adoptar este estándar, evitamos tener que interpolar píxeles en las imágenes pequeñas lo cual añadiría ruido, limitándonos únicamente a reducir las imágenes de alta resolución. Además, al aplicar un reescalado proporcional en lugar de un recorte forzado, se respeta la relación de aspecto original de cada fotografía, ya sea vertical u horizontal, asegurando que ninguna dimensión exceda los 224 píxeles sin deformar el contenido visual.
