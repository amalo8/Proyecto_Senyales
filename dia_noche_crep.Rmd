...
p_box
ggsave("boxplot_modelo_base_3clases.png", p_box, width = 10, height = 6)
```
...
p_hist
ggsave("hist_modelo_base_3clases.png", p_hist, width = 10, height = 6)
```
...
p_cm
ggsave("confusion_matrix_rf_3clases.png", p_cm, width = 6, height = 5)
```
...
p_imp
ggsave("importancia_rf_3clases.png", p_imp, width = 7, height = 5)
```
...
p_box
ggsave("boxplot_modelo_con_tonos.png", p_box, width=12, height=7)
```
...
p_grad
ggsave("boxplot_gradiente_V_bandas.png", p_grad, width = 6, height = 4)
```
...
p_hist_grad
ggsave("histograma_gradiente_V_bandas.png", p_hist_grad, width = 6, height = 4)
```
...
```{r}
vars_H <- grep("mediana_cosH|mediana_sinH", colnames(datos_train_multi_bloques), value = TRUE)
...
p_extremos
ggsave("boxplot_extremos_bloques_3x1.png", p_extremos, width = 14, height = 8, dpi = 300)
