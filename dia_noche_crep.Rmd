...
```{r}
# Extraer las cargas de PC1 a PC14
cargas <- as.data.frame(pca_resultado$rotation[, 1:14])

# Imprimir las variables más influyentes de cada PC
for (i in 1:14) {
  pc_name <- paste0("PC", i)
  
  cat("\n====================================\n")
  cat("Variables que más pesan en", pc_name, "\n")
  cat("====================================\n")
  
  PC_top <- cargas[order(-abs(cargas[[pc_name]])), pc_name, drop = FALSE]
  print(head(PC_top, 10))   # top 10 variables de ese PC
}
```
