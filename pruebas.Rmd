...
# Aplicamos la función para extraer las medianas de los canales RGB
...
train_x_hsv <- datos_train[, cols_hsv]
test_x_hsv <- datos_test[, cols_hsv]
train_y_hsv <- datos_train$etiqueta
test_y_hsv <- datos_test$etiqueta
```
...
train_x_todas <- datos_train[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana")]
test_x_todas <- datos_test[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana")]
train_y_todas <- datos_train$etiqueta
test_y_todas <- datos_test$etiqueta
...
mal_clasificadas <- datos_test[predicciones_rf_todas != test_y_todas, "ruta"]
...
train_x_sobel <- datos_train_sobel[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean")]
test_x_sobel <- datos_test_sobel[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean")]
...
train_x_fuentes <- datos_train_fuentes[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz")]
test_x_fuentes <- datos_test_fuentes[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz")]
...
train_x_entropia <- datos_train_entropia[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia")]
test_x_entropia <- datos_test_entropia[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia")]
...
train_x_final <- datos_train_final[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros")]
test_x_final <- datos_test_final[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros")]
...
train_x_rango <- datos_train_rango[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Rango_dinamico_V")]
test_x_rango <- datos_test_rango[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Rango_dinamico_V")]
...
train_x_blur <- datos_train_blur[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "V_blurred_mean")]
test_x_blur <- datos_test_blur[, c("R_mediana", "G_mediana", "B_mediana","H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "V_blurred_mean")]
...
train_x_sd <- datos_train_sd[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "V_blurred_mean", "SD_V")]
test_x_sd <- datos_test_sd[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "V_blurred_mean", "SD_V")]
...
train_x_multi <- datos_train_multi[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros")]
test_x_multi <- datos_test_multi[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros")]
...
train_x_multi_tonos <- datos_train_multi_tonos[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos")]
test_x_multi_tonos <- datos_test_multi_tonos[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos")]
...
train_x_multi_gradientes <- datos_train_multi_gradientes[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V")]
test_x_multi_gradientes <- datos_test_multi_gradientes[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V")]
...
train_x_multi_bandas <- datos_train_multi_bandas[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas")]
test_x_multi_bandas <- datos_test_multi_bandas[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas")]
...
train_x_multi_bloques <- datos_train_multi_bloques[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas",
                                                       grep("Bloque_", colnames(datos_train_multi_bloques), value = TRUE))]
test_x_multi_bloques <- datos_test_multi_bloques[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas",
...
train_x_multi_extremos <- datos_train_multi_extremos[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas",
                                                         grep("Bloque_", colnames(datos_train_multi_extremos), value = TRUE))]
test_x_multi_extremos <- datos_test_multi_extremos[, c("R_mediana", "G_mediana", "B_mediana", "H_cos_mediana", "H_sin_mediana", "S_mediana", "V_mediana", "Sobel_mean", "Fuentes_luz", "Entropia", "Pixeles_oscuros", "Tonos_calidos", "Gradiente_H", "Gradiente_V", "Gradiente_V_bandas",
