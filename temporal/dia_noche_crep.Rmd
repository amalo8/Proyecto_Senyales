...
p_box
ggsave("../figuras/boxplot_modelo_base_3clases.png", p_box, width = 10, height = 6)
```
...
p_hist
ggsave("figuras/hist_modelo_base_3clases.png", p_hist, width = 10, height = 6)
```
...
p_cm
ggsave("../figuras/confusion_matrix_rf_3clases.png", p_cm, width = 6, height = 5)
```
...
p_imp
ggsave("../figuras/importancia_rf_3clases.png", p_imp, width = 7, height = 5)
```
...
p_box
ggsave("../figuras/boxplot_modelo_con_tonos.png", p_box, width=12, height=7)
```
...
p_grad
ggsave("../figuras/boxplot_gradiente_V_bandas.png", p_grad, width = 6, height = 4)
```
...
p_hist_grad
ggsave("../figuras/histograma_gradiente_V_bandas.png", p_hist_grad, width = 6, height = 4)
```
...
p_bloques
ggsave(
  filename = "../figuras/boxplot_bloques_3x1.png",
  plot = p_bloques,
  width = 14, 
  height = 8,
  dpi = 150
...
p_H_bloques
ggsave(
  filename = "../figuras/boxplot_H_bloques_3x1.png",
  plot = p_H_bloques,
  width = 14,
  height = 7,
  dpi = 150
...
p_SD_V_bloques
ggsave(
  filename = "../figuras/boxplot_SDV_bloques_3x1.png",
  plot = p_SD_V_bloques,
  width = 12,
  height = 6,
  dpi = 150
...
p_extremos
ggsave("../figuras/boxplot_extremos_bloques_3x1.png", p_extremos, width = 14, height = 8, dpi = 300)
...
p_osc_zonas
ggsave(
  filename = "../figuras/boxplot_pixeles_oscuros_zonas.png",
  plot = p_osc_zonas,
  width = 10,
  height = 6,
  dpi = 150
...
p_brill_zonas
ggsave(
  filename = "../figuras/boxplot_pixeles_brillantes_zonas.png",
  plot = p_brill_zonas,
  width = 10,
  height = 6,
  dpi = 150
...
```{r}
save(rf_dia_noche_crep,vars_finales,file = "../modelos/rf_dia_noche_crep_full.RData")
```
...
```{r}
save(pca_resultado,rf_pca,vars_finales,n_comp,file = "../modelos/rf_dia_noche_crep_pca.RData")
```
